...
public class GuestPreferences implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2067081533871175150L;
	...
	public void updateTheme(String theme, boolean darkMenu) {
		this.theme = theme;
    ...
    public void toggleDarkMenu() {
        this.darkMenu = !this.darkMenu;
        this.updateTheme(this.theme, this.darkMenu);
    }
