...
public class CustomKullaniciIletisimRepository {
	...
	public BooleanExpression kriter(KullaniciIletisim kullaniciIletisim, String sorgu) {
		...
		if(Util.notEmpty(sorgu)) {
			...
			booleanExpressionAdvancedSearch = Util.or(booleanExpressionAdvancedSearch, QKullaniciIletisim.kullaniciIletisim.cep_telefonu.likeIgnoreCase("%" + kullaniciIletisim.getCep_telefonu() + "%"));
			booleanExpressionAdvancedSearch = Util.or(booleanExpressionAdvancedSearch, QKullaniciIletisim.kullaniciIletisim.eposta.likeIgnoreCase("%" + kullaniciIletisim.getEposta() + "%"));
	...
	public Page<KullaniciIletisim> sorgula(int pageSize, int pageNumber, Map<String, SortMeta> sort, KullaniciIletisim kullaniciIletisim, String sorgu) {
		BooleanExpression booleanExpression = kriter(kullaniciIletisim, sorgu);
