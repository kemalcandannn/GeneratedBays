...
public class CustomKullaniciRepository {
	...
	public BooleanExpression kriter(Kullanici kullanici, String sorgu) {
		...
		if(Util.notEmpty(sorgu)) {
			...
			booleanExpressionAdvancedSearch = Util.or(booleanExpressionAdvancedSearch, QKullanici.kullanici.ad.likeIgnoreCase("%" + sorgu + "%"));
			booleanExpressionAdvancedSearch = Util.or(booleanExpressionAdvancedSearch, QKullanici.kullanici.soyad.likeIgnoreCase("%" + sorgu + "%"));
			booleanExpressionAdvancedSearch = Util.or(booleanExpressionAdvancedSearch, QKullanici.kullanici.kullanici_adi.likeIgnoreCase("%" + sorgu + "%"));
